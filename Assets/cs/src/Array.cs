...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array 
{
	...
	public    Array(global::haxe.lang.EmptyObject empty)
	{
		unchecked 
		{
			#line 36 "/usr/lib/haxe/std/cs/_std/Array.hx"
			{
			}
	...
	public    Array()
	{
		unchecked 
		{
			#line 64 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   object Array_cast<T1>()
	{
		unchecked 
		{
			...
			{
				#line 36 "/usr/lib/haxe/std/cs/_std/Array.hx"
				object __temp_iterator20 = global::Reflect.fields(this).iterator();
				#line 36 "/usr/lib/haxe/std/cs/_std/Array.hx"
				while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator20, "hasNext", 407283053, default(global::Array))) ))
				{
					#line 36 "/usr/lib/haxe/std/cs/_std/Array.hx"
					string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator20, "next", 1224901875, default(global::Array)));
					#line 36 "/usr/lib/haxe/std/cs/_std/Array.hx"
					switch (field)
					{
						case "__a":
	...
	public   global::Array<T> concat(global::Array<T> a)
	{
		unchecked 
		{
			...
			#line 80 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   void concatNative(T[] a)
	{
		unchecked 
		{
			#line 85 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int len = ( this.length + a.Length );
			if (( __a.Length >= len )) 
			{
			...
			{
				#line 91 "/usr/lib/haxe/std/cs/_std/Array.hx"
			...
			#line 98 "/usr/lib/haxe/std/cs/_std/Array.hx"
			this.length = len;
		}
		#line default
	}
	...
	public   string @join(string sep)
	{
		unchecked 
		{
			#line 106 "/usr/lib/haxe/std/cs/_std/Array.hx"
			global::StringBuf buf = new global::StringBuf();
			int i = -1;
			#line 109 "/usr/lib/haxe/std/cs/_std/Array.hx"
			bool first = true;
			int length = this.length;
			while ((  ++ i < length ))
			{
				#line 113 "/usr/lib/haxe/std/cs/_std/Array.hx"
				if (first) 
				{
					first = false;
				}
				...
				{
					#line 116 "/usr/lib/haxe/std/cs/_std/Array.hx"
			...
			#line 120 "/usr/lib/haxe/std/cs/_std/Array.hx"
			return buf.toString();
		}
		#line default
	}
	...
	public   global::haxe.lang.Null<T> pop()
	{
		unchecked 
		{
			#line 128 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int length = this.length;
			if (( length > 0 )) 
			{
				#line 132 "/usr/lib/haxe/std/cs/_std/Array.hx"
				T val = __a[ -- length];
				__a[length] = default(T);
				this.length = length;
				#line 136 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   global::haxe.lang.Null<T> shift()
	{
		unchecked 
		{
			#line 184 "/usr/lib/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( l == 0 )) 
			{
				return default(global::haxe.lang.Null<T>);
			...
			#line 188 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			T x = a[0];
			l -= 1;
			...
			a[l] = default(T);
			this.length = l;
			#line 195 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> slice(int pos, global::haxe.lang.Null<int> end)
	{
		unchecked 
		{
			...
			if (( len < 0 )) 
			{
				#line 218 "/usr/lib/haxe/std/cs/_std/Array.hx"
			...
			#line 223 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   void quicksort(int lo, int hi, global::haxe.lang.Function f)
	{
		unchecked 
		{
			#line 244 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] buf = this.__a;
			int i = lo;
			#line 245 "/usr/lib/haxe/std/cs/_std/Array.hx"
			int j = hi;
			T p = buf[( ( i + j ) >> 1 )];
			while (( i <= j ))
			{
			...
			if (( i < hi )) 
			{
				#line 260 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> splice(int pos, int len)
	{
		unchecked 
		{
			#line 268 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( len < 0 )) 
			{
				#line 268 "/usr/lib/haxe/std/cs/_std/Array.hx"
				return new global::Array<T>();
			...
			if (( pos < 0 )) 
			{
				...
				if (( pos < 0 )) 
				{
					#line 271 "/usr/lib/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 273 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( pos > this.length )) 
			{
				pos = 0;
				len = 0;
	...
	public   void spliceVoid(int pos, int len)
	{
		unchecked 
		{
			#line 296 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( len < 0 )) 
			{
				#line 296 "/usr/lib/haxe/std/cs/_std/Array.hx"
				return ;
			...
			if (( pos < 0 )) 
			{
				...
				if (( pos < 0 )) 
				{
					#line 299 "/usr/lib/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 301 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( pos > this.length )) 
			{
				pos = 0;
				len = 0;
			 ...
			 else 
			{
				if (( ( pos + len ) > this.length )) 
				{
					...
					if (( len < 0 )) 
					{
						#line 306 "/usr/lib/haxe/std/cs/_std/Array.hx"
						len = 0;
					}
			...
			T[] a = this.__a;
			#line 310 "/usr/lib/haxe/std/cs/_std/Array.hx"
			int end = ( pos + len );
			global::System.Array.Copy(a, end, a, pos, ( this.length - end ));
			this.length -= len;
			while ((  -- len >= 0 ))
	...
	public   string toString()
	{
		unchecked 
		{
			#line 322 "/usr/lib/haxe/std/cs/_std/Array.hx"
			global::StringBuf ret = new global::StringBuf();
			T[] a = this.__a;
			ret.b.Append(((object) ("[") ));
			bool first = true;
			{
				#line 326 "/usr/lib/haxe/std/cs/_std/Array.hx"
				int _g1 = 0;
				#line 326 "/usr/lib/haxe/std/cs/_std/Array.hx"
				int _g = this.length;
				#line 326 "/usr/lib/haxe/std/cs/_std/Array.hx"
				while (( _g1 < _g ))
				{
					#line 326 "/usr/lib/haxe/std/cs/_std/Array.hx"
					int i = _g1++;
					#line 328 "/usr/lib/haxe/std/cs/_std/Array.hx"
					if (first) 
					{
						first = false;
					}
					...
					{
						#line 331 "/usr/lib/haxe/std/cs/_std/Array.hx"
						ret.b.Append(((object) (",") ));
					}
			...
			#line 335 "/usr/lib/haxe/std/cs/_std/Array.hx"
			ret.b.Append(((object) ("]") ));
			return ret.toString();
		}
		#line default
	...
	public   void unshift(T x)
	{
		unchecked 
		{
			...
			{
				#line 348 "/usr/lib/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( length << 1 )) + 1 );
				T[] newarr = new T[((int) (newLen) )];
				global::System.Array.Copy(__a, 0, newarr, 1, length);
				#line 352 "/usr/lib/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
			}
			 else 
			{
	...
	public   void insert(int pos, T x)
	{
		unchecked 
		{
			#line 367 "/usr/lib/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( pos < 0 )) 
			{
				pos = ( l + pos );
			...
			#line 372 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( pos >= l )) 
			{
				this.push(x);
				return ;
			...
			{
				#line 382 "/usr/lib/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( this.length << 1 )) + 1 );
				T[] newarr = new T[((int) (newLen) )];
	...
	public   bool @remove(T x)
	{
		unchecked 
		{
			#line 406 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int i = -1;
			int length = this.length;
			while ((  ++ i < length ))
			{
				if (global::haxe.lang.Runtime.eq(__a[i], x)) 
				{
					...
					#line 416 "/usr/lib/haxe/std/cs/_std/Array.hx"
					return true;
				}
				
			}
			
			#line 420 "/usr/lib/haxe/std/cs/_std/Array.hx"
			return false;
		}
		#line default
	}
	...
	public   global::Array<S> map<S>(global::haxe.lang.Function f)
	{
		unchecked 
		{
			#line 424 "/usr/lib/haxe/std/cs/_std/Array.hx"
			global::Array<S> ret = new global::Array<S>(new S[]{});
			{
				#line 425 "/usr/lib/haxe/std/cs/_std/Array.hx"
				int _g = 0;
				#line 425 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> filter(global::haxe.lang.Function f)
	{
		unchecked 
		{
			#line 431 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> copy()
	{
		unchecked 
		{
			#line 444 "/usr/lib/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			T[] __a = this.__a;
			T[] newarr = new T[((int) (len) )];
	...
	public   object iterator()
	{
		unchecked 
		{
			#line 454 "/usr/lib/haxe/std/cs/_std/Array.hx"
			global::Array<object> _g = new global::Array<object>(new object[]{this});
			#line 456 "/usr/lib/haxe/std/cs/_std/Array.hx"
			global::Array<int> i = new global::Array<int>(new int[]{0});
			global::Array<int> len = new global::Array<int>(new int[]{this.length});
			#line 459 "/usr/lib/haxe/std/cs/_std/Array.hx"
			{
				global::haxe.lang.Function __temp_odecl24 = new global::Fun_d33f25a3(((global::Array<int>) (global::Array<object>.__hx_cast<int>(((global::Array) (i) ))) ), ((global::Array<int>) (global::Array<object>.__hx_cast<int>(((global::Array) (len) ))) ));
				global::haxe.lang.Function __temp_odecl25 = new global::Fun_ebdb9599<T>(((global::Array<int>) (global::Array<object>.__hx_cast<int>(((global::Array) (i) ))) ), ((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (_g) ))) ));
				#line 459 "/usr/lib/haxe/std/cs/_std/Array.hx"
				return new global::haxe.lang.DynamicObject(new global::Array<int>(new int[]{407283053, 1224901875}), new global::Array<object>(new object[]{__temp_odecl24, __temp_odecl25}), new global::Array<int>(new int[]{}), new global::Array<double>(new double[]{}));
			}
	...
	public   T __get(int idx)
	{
		unchecked 
		{
			#line 467 "/usr/lib/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			uint idx1 = ((uint) (idx) );
			if (( idx1 >= this.length )) 
			{
	...
	public   T __set(int idx, T v)
	{
		unchecked 
		{
			#line 477 "/usr/lib/haxe/std/cs/_std/Array.hx"
			uint idx1 = ((uint) (idx) );
			T[] __a = this.__a;
			if (( idx1 >= __a.Length )) 
			{
				#line 481 "/usr/lib/haxe/std/cs/_std/Array.hx"
				uint len = ( idx1 + 1 );
				if (( idx1 == __a.Length )) 
				{
					len = ((uint) (( (( idx1 << 1 )) + 1 )) );
			...
			#line 489 "/usr/lib/haxe/std/cs/_std/Array.hx"
			if (( idx1 >= this.length )) 
			{
				this.length = ((int) (( idx1 + 1 )) );
			}
			
			#line 492 "/usr/lib/haxe/std/cs/_std/Array.hx"
	...
	public   T __unsafe_get(int idx)
	{
		unchecked 
		{
			#line 496 "/usr/lib/haxe/std/cs/_std/Array.hx"
			return this.__a[idx];
		}
		#line default
	}
	...
	public   T __unsafe_set(int idx, T val)
	{
		unchecked 
		{
			#line 501 "/usr/lib/haxe/std/cs/_std/Array.hx"
...
#pragma warning disable 109, 114, 219, 429, 168, 162
public  class Fun_d33f25a3 : global::haxe.lang.Function 
{
	public    Fun_d33f25a3(global::Array<int> i, global::Array<int> len) : base(0, 0)
	{
		unchecked 
		{
			#line 460 "/usr/lib/haxe/std/cs/_std/Array.hx"
			this.i = i;
			#line 460 "/usr/lib/haxe/std/cs/_std/Array.hx"
			this.len = len;
		}
...
#pragma warning disable 109, 114, 219, 429, 168, 162
public  class Fun_ebdb9599<T> : global::haxe.lang.Function 
{
	public    Fun_ebdb9599(global::Array<int> i, global::Array<object> _g) : base(0, 0)
	{
		unchecked 
		{
			#line 461 "/usr/lib/haxe/std/cs/_std/Array.hx"
			this.i = i;
			#line 461 "/usr/lib/haxe/std/cs/_std/Array.hx"
			this._g = _g;
		}
