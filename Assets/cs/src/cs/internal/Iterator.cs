...
namespace haxe.lang
{
	...
	{
		public static   object __hx_cast<T1>(global::haxe.lang.Iterator me)
		{
			unchecked 
			{
				#line 24 "/usr/lib/haxe/std/cs/internal/Iterator.hx"
				return ( (( me != default(global::haxe.lang.Iterator) )) ? (me.haxe_lang_Iterator_cast<T1>()) : (default(global::haxe.lang.Iterator)) );
			}
			#line default
		}
...
namespace haxe.lang
{
	...
	{
		   object haxe_lang_Iterator_cast<T>();
...
namespace haxe.lang
{
	...
	{
		public static   object __hx_cast<T1>(global::haxe.lang.Iterable me)
		{
			unchecked 
			{
				#line 33 "/usr/lib/haxe/std/cs/internal/Iterator.hx"
				return ( (( me != default(global::haxe.lang.Iterable) )) ? (me.haxe_lang_Iterable_cast<T1>()) : (default(global::haxe.lang.Iterable)) );
			}
			#line default
		}
...
namespace haxe.lang
{
	...
	{
		   object haxe_lang_Iterable_cast<T>();
