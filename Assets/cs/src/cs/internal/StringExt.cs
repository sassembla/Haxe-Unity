...
namespace haxe.lang
{
	public  class StringExt 
	{
		...
		public static   string toNativeString(string me)
		{
			unchecked 
			{
				#line 196 "/usr/lib/haxe/std/cs/internal/StringExt.hx"
				return me;
			}
			#line default
		}
...
namespace haxe.lang
{
	public  class StringRefl 
	{
		static StringRefl() 
		{
			#line 211 "/usr/lib/haxe/std/cs/internal/StringExt.hx"
		...
		public    StringRefl()
		{
			unchecked 
			{
				#line 209 "/usr/lib/haxe/std/cs/internal/StringExt.hx"
				{
				}
		...
		public static   object handleGetField(string str, string f, bool throwErrors)
		{
			unchecked 
			{
				...
				switch (f)
				{
					case "length":
					{
						#line 217 "/usr/lib/haxe/std/cs/internal/StringExt.hx"
						return str.Length;
					}
		...
		public static   object handleCallField(string str, string f, global::Array args)
		{
			unchecked 
			{
				#line 230 "/usr/lib/haxe/std/cs/internal/StringExt.hx"
