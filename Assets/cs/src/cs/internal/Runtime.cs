...
namespace haxe.lang
{
	...
	public static object callField(haxe.lang.HxObject obj, string field, int fieldHash, Array args)
	{
		...
		public static   object callMethod(object obj, global::System.Reflection.MethodBase[] methods, int methodLength, global::Array args)
		{
			unchecked 
			{
				#line 422 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				if (( methodLength == 0 )) 
				{
					#line 422 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				...
				#line 428 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				{
					#line 428 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					int _g = 0;
					#line 428 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					while (( _g < ((int) (length) ) ))
					{
						#line 428 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int i = _g++;
						#line 430 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						oargs[i] = args[i];
				...
				#line 435 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				int last = 0;
				#line 438 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				if (( methodLength > 1 )) 
				{
					#line 440 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					{
						#line 440 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int _g1 = 0;
						#line 440 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						while (( _g1 < methodLength ))
						{
							#line 440 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							int i1 = _g1++;
							#line 442 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							global::System.Reflection.ParameterInfo[] @params = methods[i1].GetParameters();
							if (( @params.Length != length )) 
							{
								#line 443 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
								continue;
							}
							 else 
							{
								#line 446 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
								bool fits = true;
								#line 446 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
								int crate = 0;
								{
									#line 447 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
									int _g2 = 0;
									#line 447 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
									...
									while (( _g2 < _g11 ))
									{
										#line 447 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
										int i2 = _g2++;
										#line 449 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
										...
										{
											#line 455 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
											...
											{
												#line 458 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
												crate++;
												continue;
											}
											 else 
								...
								if (fits) 
								{
									#line 468 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
									rates[last] = crate;
					...
					#line 474 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					methodLength = last;
				}
				 else 
				{
				...
				#line 484 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				if (( methodLength == 0 )) 
				{
				...
				int bestMethod = 0;
				{
					...
					while (( _g3 < methodLength ))
					{
						#line 489 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int i3 = _g3++;
						#line 491 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						if (( rates[i3] < best )) 
						{
							#line 493 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							bestMethod = i3;
				...
				{
					#line 500 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					int _g12 = 0;
					#line 500 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					...
					while (( _g12 < _g4 ))
					{
						#line 500 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int i4 = _g12++;
						#line 502 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						...
						{
							#line 507 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							if ((((global::System.Type) (typeof(global::System.IConvertible)) )).IsAssignableFrom(param1)) 
							{
								...
								if (global::haxe.lang.Runtime.eq(oargs[i4], default(object))) 
								{
									...
									{
										#line 510 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				...
				if (( methods[0].ContainsGenericParameters && ( methods[0] is global::System.Reflection.MethodInfo ) )) 
				{
					...
					{
						#line 521 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int _g13 = 0;
						#line 521 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						int _g5 = tgs.Length;
						#line 521 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						while (( _g13 < _g5 ))
						{
							#line 521 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							int i5 = _g13++;
							#line 523 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
							tgs[i5] = typeof(object);
						}
						
					}
					
					#line 525 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
		...
		public static   object unbox(object dyn)
		{
			unchecked 
			{
				#line 542 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				...
				{
					#line 544 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					return ((object) (global::haxe.lang.Runtime.callField(dyn, "toDynamic", 1705629508, default(global::Array))) );
				}
				 else 
				{
					#line 546 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
					return dyn;
				}
		...
		public static   string toString(object obj)
		{
			unchecked 
			{
				#line 679 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				...
				if (( obj is bool )) 
				{
					...
					{
						#line 685 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
						return "false";
					}
					
				}
				
				#line 687 "/usr/lib/haxe/std/cs/internal/Runtime.hx"
				return obj.ToString();
			}
			#line default
		}
