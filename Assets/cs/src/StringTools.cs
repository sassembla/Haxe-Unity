...
public  class StringTools : global::haxe.lang.HxObject 
{
	...
	public static   void __hx_ctor__StringTools(global::StringTools __temp_me7)
	{
		unchecked 
		{
			#line 32 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string urlEncode(string s)
	{
		unchecked 
		{
			#line 37 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string urlDecode(string s)
	{
		unchecked 
		{
			#line 62 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string htmlEscape(string s, global::haxe.lang.Null<bool> quotes)
	{
		unchecked 
		{
			#line 96 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string htmlUnescape(string s)
	{
		unchecked 
		{
			#line 113 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   bool startsWith(string s, string start)
	{
		unchecked 
		{
			#line 124 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   bool endsWith(string s, string end)
	{
		unchecked 
		{
			#line 141 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   bool isSpace(string s, int pos)
	{
		unchecked 
		{
			#line 163 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string ltrim(string s)
	{
		unchecked 
		{
			#line 176 "/usr/lib/haxe/std/StringTools.hx"
			return s.TrimStart();
		}
		#line default
	}
	...
	public static   string rtrim(string s)
	{
		unchecked 
		{
			#line 201 "/usr/lib/haxe/std/StringTools.hx"
			return s.TrimEnd();
		}
		#line default
	}
	...
	public static   string trim(string s)
	{
		unchecked 
		{
			#line 223 "/usr/lib/haxe/std/StringTools.hx"
			return s.Trim();
		}
		#line default
	}
	...
	public static   string lpad(string s, string c, int l)
	{
		unchecked 
		{
			#line 246 "/usr/lib/haxe/std/StringTools.hx"
			if (( c.Length <= 0 )) 
			{
				return s;
			}
	...
	public static   string replace(string s, string sub, string @by)
	{
		unchecked 
		{
			#line 288 "/usr/lib/haxe/std/StringTools.hx"
			if (( sub.Length == 0 )) 
			{
				#line 296 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   string hex(int n, global::haxe.lang.Null<int> digits)
	{
		unchecked 
		{
			#line 316 "/usr/lib/haxe/std/StringTools.hx"
			string s = "";
			...
			while (( n > 0 ));
			#line 323 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   int fastCodeAt(string s, int index)
	{
		unchecked 
		{
			#line 339 "/usr/lib/haxe/std/StringTools.hx"
	...
	public static   bool isEof(int c)
	{
		unchecked 
		{
			#line 366 "/usr/lib/haxe/std/StringTools.hx"
			return ( c == -1 );
		}
		#line default
	}
